<template>
  <div class="max-w-sm mx-auto py-24">
    ...
    <form @submit.prevent="onSubmit" class="space-y-4">
      ...
      <button type="submit" class="w-full bg-black text-white rounded py-2">Войти</button>
      <p class="text-sm mt-2">Нет аккаунта? <router-link to="/register" class="underline">Регистрация</router-link></p>
